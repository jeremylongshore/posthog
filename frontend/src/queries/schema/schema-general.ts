 ...
 * - `force`: Bypass cache and force a fresh fetch from the data source
 * - `direct`: Query the database directly, bypassing materialization (only valid for materialized endpoints)
 */
